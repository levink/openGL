...
BSplineBasis uBasis(25,OpenBasis,N1,3,0,1);
BSplineBasis vBasis(25,OpenBasis,N2,3,0,1);
...
void init() {
	bsp.ControlPoint(0,0) = double3(-1,-1,-1);
	bsp.ControlPoint(0,1) = double3(-0.75,1,-1);
	bsp.ControlPoint(0,2) = double3(0.75,1,-1);
	bsp.ControlPoint(0,3) = double3(1,-1,-1);

	bsp.ControlPoint(1,0) = double3(-1.2,-1,-0.33);
	bsp.ControlPoint(1,1) = double3(-1.0,1,-0.33);
	bsp.ControlPoint(1,2) = double3(1.0,1,-0.33);
	bsp.ControlPoint(1,3) = double3(1.2,-1,-0.33);

	bsp.ControlPoint(2,0) = double3(-1,-1,0.33);
	bsp.ControlPoint(2,1) = double3(-0.75,1,0.33);
	bsp.ControlPoint(2,2) = double3(0.75,1,0.33);
	bsp.ControlPoint(2,3) = double3(1,-1,0.33);

	bsp.ControlPoint(3,0) = double3(0,0,1);
	bsp.ControlPoint(3,1) = double3(0,0,1);
	bsp.ControlPoint(3,2) = double3(0,0,1);
	bsp.ControlPoint(3,3) = double3(0,0,1);
